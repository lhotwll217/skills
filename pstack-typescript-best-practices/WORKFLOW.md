...
Apply the [pstack-principle-type-system-discipline](../pstack-principle-type-system-discipline/WORKFLOW.md) principle skill first.
...
| Boundary validation | Parse where data crosses in, into a named domain type. `Record<string, unknown>` (however spelled) stops at that parse. Trust types inside. See the [pstack-principle-boundary-discipline](../pstack-principle-boundary-discipline/WORKFLOW.md) principle skill. |
