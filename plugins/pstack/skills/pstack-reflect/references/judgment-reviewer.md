...
- file-read tool calls against `SKILL.md` and its linked `WORKFLOW.md` references (workspace `.agents/skills/`, user-level `~/.agents/skills/`, or the harness’s configured skill roots)
- the supported delegation API prompts that name a skill path
