...
1. Identify the format and load it with the right tool. Parse large artifacts in a subagent (the [pstack-principle-guard-the-context-window](../../pstack-principle-guard-the-context-window/WORKFLOW.md) skill) and keep the reduced finding in the main thread.
