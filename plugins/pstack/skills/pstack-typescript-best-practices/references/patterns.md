...
Code examples for each rule in [WORKFLOW.md](../WORKFLOW.md). The underlying principles are language-agnostic. See the [pstack-principle-type-system-discipline](../../pstack-principle-type-system-discipline/WORKFLOW.md) and [pstack-principle-boundary-discipline](../../pstack-principle-boundary-discipline/WORKFLOW.md) principle skills.
...
Validate once where data crosses in. Trust types inside. See the [pstack-principle-boundary-discipline](../../pstack-principle-boundary-discipline/WORKFLOW.md) principle skill.
