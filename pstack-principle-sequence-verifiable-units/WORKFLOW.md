...
The sequencing complement to the [pstack-principle-prove-it-works](../pstack-principle-prove-it-works/WORKFLOW.md) principle skill, which keeps each check real, and the [pstack-principle-build-the-lever](../pstack-principle-build-the-lever/WORKFLOW.md) principle skill, which makes the per-unit check cheap.
