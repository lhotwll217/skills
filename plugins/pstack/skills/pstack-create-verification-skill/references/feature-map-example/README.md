...
Illustrative template only. Notes, `control-notes`, selectors, ports, and fixtures below are examples, not installed capabilities. Replace them with observed project facts when generating a verification map.
